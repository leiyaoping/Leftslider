...
//  Leftslider
//
//  Created by 雷窑平 on 16/9/13.
//  Copyright © 2016年 雷窑平. All rights reserved.
//
...
#define MainPageDistance  kScreenWidth/3   //打开左侧窗时，中视图(右视图)露出的宽度

#define kMainPageDistance   MainPageDistance   //打开左侧窗时，中视图(右视图)露出的宽度
